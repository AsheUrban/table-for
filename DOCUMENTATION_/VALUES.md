...
- **User Trust** |
Privacy-first. No monetization of user data. No selling, targeting, or advertising. Users should feel safe and respected.
- **Thoughtful Design** |
Every decision should reflect care for the people using the app. No dark patterns, no engagement tricks.
- **Real Connection** |
This app exists to bring people together over food — friends and strangers alike. Features serve that purpose.
- **Accessibility** |
Usable by everyone. Design for screen readers, diverse dietary needs, and varying levels of tech comfort.
- **Open to Growth** |
Welcome different ways people connect over food. Friends, strangers, solo diners, group organizers, don't assume one "right" way to use the app.
- **Transparency** |
Be honest with users about how the app works, what data is collected, and why. No hidden mechanics.
